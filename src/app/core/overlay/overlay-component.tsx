...
export const OverlayComponent: React.FC<OverlayComponentProps> = ({ 
  ...
  return (
    <div className={`overlay ${enabled ? 'active' : ''}`} data-testid="overlay-container">
      <div className="overlay-background" data-testid="overlay-background"></div>
      <div className="overlay-content" data-testid="overlay-content" dangerouslySetInnerHTML={dangerouslySetInnerHTML}>
      </div>
    </div>
  );
};
