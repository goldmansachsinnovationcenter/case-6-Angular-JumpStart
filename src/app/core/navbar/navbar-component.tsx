    ...
    <nav className="navbar navbar-inner navbar-fixed-top">
      <div className="container">
        <div className="navbar-header">
          ...
          <a className="navbar-brand" onClick={() => navigateTo('/customers')} data-testid="navbar-brand">
          ...
          <span className="navbar-collapse" data-collapse={isCollapsed ? "true" : "false"}>
            <ul className="nav navbar-nav nav-pills navBarPadding">
              <li className={isActive('/customers') ? 'active' : ''}>
                <a onClick={() => navigateTo('/customers')} data-testid="navbar-customers">Customers</a>
              </li>
              <li className={isActive('/orders') ? 'active' : ''}>
                <a onClick={() => navigateTo('/orders')} data-testid="navbar-orders">Orders</a>
              </li>
              <li className={isActive('/about') ? 'active' : ''}>
                <a onClick={() => navigateTo('/about')} data-testid="navbar-about">About</a>
              </li>
              <li className={isActive('/login') ? 'active' : ''} onClick={loginOrOut} data-cy="login-logout">
                <a data-testid="navbar-login-logout">{loginLogoutText}</a>
              </li>
            </ul>
          </span>
        </div>
